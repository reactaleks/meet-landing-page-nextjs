...
export default function HeroComponent() {
  return (
    <div className="grid grid-cols-12 grid-rows-12 h-[620px] relative overflow-hidden mb-44 md:mb-56">
        ...
        <Image
          ...
          md:w-[394px] md:h-[303px] md:row-span-6
          "
        />
        <Image
        ...
        md:flex-row md:justify-around md:col-span-6 md:col-start-4 md:row-start-11
        ">
