...
export default function HeroComponent() {
  return (
    <div className="grid grid-cols-12 grid-rows-12 h-[620px] lg:h-[358px] relative overflow-hidden mb-44 md:mb-56">
        ...
        <Image
          ...
          md:w-[394px] md:h-[303px] md:row-span-6 lg:-left-[100px] xl:-left-[25px]
          "
        />
        <Image
          ...
          md:w-[394px] md:h-[303px] md:row-span-6 lg:-right-[100px] xl:-right-[25px]
          "
        />
        ...
        lg:row-start-6 lg:col-span-4 lg:col-start-5
